...
install -d -m 0775 '/var/lib/mappi3/themes/four-seasons-theme'
cat > "$MARKER_DIR/installed.json" <<JSON
{"id":"$PLUGIN_ID","status":"installed","offline_safe":true,"installed_at":"$(date -Is)","features":["four_seasons"],"note":"Theme metadata installed; UI theme is bundled in the web app."}
JSON
